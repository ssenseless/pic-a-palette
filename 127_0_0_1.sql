...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2022 at 04:08 AM
...
('root', '[{\"db\":\"pic_a_palette\",\"table\":\"palette_count\"},{\"db\":\"pic_a_palette\",\"table\":\"user\"},{\"db\":\"pic_a_palette\",\"table\":\"palette_hex\"},{\"db\":\"pic-a-palette\",\"table\":\"user\"}]');
...
('root', '2022-12-03 03:08:05', '{\"Console\\/Mode\":\"collapse\"}');
...
--
-- Table structure for table `user_palettes`
--
...
CREATE TABLE `user_palettes` (
  ...
  `hex2` varchar(7) DEFAULT NULL,
  `hex3` varchar(7) DEFAULT NULL,
  `hex4` varchar(7) DEFAULT NULL,
  `hex5` varchar(7) DEFAULT NULL,
  `hex6` varchar(7) DEFAULT NULL,
